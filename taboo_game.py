    ...
    def build_ui():
        ...
        if state["step"] == "rules":
            view.controls += [
                ...
                ft.Text("كل فريق يحاول جعل اللاعب يخمن الكلمة السرية بدون استخدام الكلمات الممنوعة.", size=18),
                ft.Text("🕹 كيفية اللعب:", size=22, weight="bold"),
                ft.Text("كل فريق يلعب لمدة 60 ثانية في كل جولة. كل إجابة صحيحة = +1، وكل تخطي أو كلمة ممنوعة = -0.5.", size=18),
